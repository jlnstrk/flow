...
class InfoBackdropFragment : BackdropFragment(), View.OnClickListener {
    override val maxNumSharedElements: Int = 2
    override val headerRes: Int = R.string.header_status_messages
    override val menuRes: Int = R.menu.menu_backdrop_info
    override val anchorPosition: Int = 2
