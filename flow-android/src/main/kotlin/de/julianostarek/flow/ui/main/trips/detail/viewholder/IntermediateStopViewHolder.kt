...
import de.julianostarek.flow.databinding.ItemStopBinding
...
class IntermediateStopViewHolder(parent: ViewGroup) :
    BindingViewHolder<Stop, ItemStopBinding>(parent, ItemStopBinding::inflate) {
